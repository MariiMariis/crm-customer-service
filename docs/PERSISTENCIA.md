# Camada de Persistência — Etapa 2 (TP2)

Este documento descreve o design da camada de persistência do CRM de Customer
Service, construída com **JPA (Hibernate 6.5)**, **Spring Data JPA**,
**Spring Data Envers** e **Hibernate Envers** sobre **H2** em modo arquivo.
Ele complementa o `README.md` e cobre: modelo de dados, decisões de mapeamento,
repositórios e exemplos de uso, gerenciamento de transações/integridade/
performance, histórico de mudanças (auditoria) e a estratégia de testes.
...
### 2.2 Entidades e anotações JPA utilizadas
...
### 2.3 Máquina de estados do ticket
...
### 3.4 `TicketStatusHistoryRepository`
...
### 3.5 Specifications (filtros dinâmicos)
...
### 3.6 Exemplos de uso nos serviços
...
## 4. Gerenciamento de dados: transações, integridade e performance
...
### 5.1 Auditoria de metadados (Spring Data JPA Auditing)
...
### 5.2 Histórico completo de entidades (Hibernate Envers)
...
### 5.3 Quando usar cada histórico
...
| `spring.jpa.open-in-view` | `false` | Ver seção 4.3 |
